...
st.title("Gomoku")
st.write("Similar to TicTacToe Gomoku requires you to get 4 in a row in a bigger board but you can only place pieces next to each other.")
...
st.write("Account funding link: https://bank.testnet.algorand.network/")
...
st.write("In this step we deploy the Gomoku Stateful Smart Contract to the Algorand TestNetwork")
...
def to_binary(integer):
    return format(integer, 'b').zfill(100)
